...
def visualize_boxes_and_labels_on_image_array(
  ...
  for box, color in box_to_color_map.items():
    ...
    if keypoints is not None:
      draw_keypoints_on_image_array(
          ...
          use_normalized_coordinates=use_normalized_coordinates)
  with open(path+".csv",'w') as output_file:
    ...
    for k in birds:
     data=[]
     data.append(k)
     data.append(birds[k][1])
     data.append(birds[k][0])
     out.writerow(data)
     data=[]
     data.append(k)
     data.append(birds[k][1])
     data.append(birds[k][2])
     out.writerow(data)
     data=[]
     data.append(k)
     data.append(birds[k][3])
     data.append(birds[k][0])
     out.writerow(data)
     data=[]
     data.append(k)
  ...
  mydata_file = open(path+".json",'w')
  
  mydata_file.write(json.dumps(birds))
  mydata_file.close()
  output_file.close()
